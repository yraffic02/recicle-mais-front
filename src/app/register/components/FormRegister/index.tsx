    ...
    <div className="media-md-h">
      <section className="flex flex-col items-center justify-center gap-4">
        ...
        {curretStep === 1 && (
          <h2 className="font-semibold text-cinzaEscuro">
            Quase lá! Escolha um avatar que melhor te representa para continuar
            seu cadastro
          </h2>
        )}
        ...
        {curretStep === 0 && (
          <h2 className="font-semibold text-cinzaEscuro">
            Faça parte deste movimento, e ajude o mundo a se tornar cada vez
      ...
      {curretStep === 0 && (
        <div className="w-full pt-5">
          <h1 className="font-semibold text-cinzaEscuro text-center">Ou</h1>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        {curretStep === 0 && (
          <section className="flex flex-col items-start gap-2 mb-3 pb-20">
            ...
            <Input
              ...
              {...register("name")}
            />
            <span className="text-[#A81212] text-xs">
              {errors.name?.message}
            </span>
        ...
        {curretStep === 1 && <AvatarsForm />}

        {curretStep === 1 && (
          <div className="flex flex-col items-center justify-center gap-2  w-full absolute bottom-0">
            <Button typeButton="primary">Criar Conta</Button>
            <div className="flex items-center justify-center gap-1">
              <input type="checkbox" id="terms" className="h-5 w-5 rounded" />
              <label htmlFor="terms" className="font-semibold text-sm">
                Aceito os <b className="underline">termos</b> e{" "}
                <b className="underline">políticas de privacidade</b>
              </label>
            </div>
          </div>
        )}
      ...
      {curretStep === 0 && (
        <div className="flex flex-col items-center justify-center gap-1 bg-white w-full absolute bottom-0">
          <Button typeButton="primary" onClick={handleNextStepForm}>
            Continuar
          </Button>
          <div className="flex items-center justify-center gap-1">
